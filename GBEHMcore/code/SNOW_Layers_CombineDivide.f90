...
!
  ...
  real(r8), INTENT(in) :: &
        ...
        fiold(lb : 0),&! fraction of ice relative to the total water content at the previous time step 
...
!----------------------- local variables ------------------------------
  ...
  real(r8) :: &
       ...
       fi,            &! Fraction of ice relative to the total water content at the current time step
       td,            &! t_soisno - tfrz [K]
