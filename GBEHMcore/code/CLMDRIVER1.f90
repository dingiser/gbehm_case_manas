SUBROUTINE CLMDRIVER (mask,run_pbsm,nl_soil,maxsnl,nl_lake,lon_points,lat_points,deltim,oro,&
           ...
           chil,         ref,          tran,                        &         
           forc_xy_t ,forc_xy_q,forc_xy_psrf,forc_xy_solarin  , &
           forc_xy_frl,forc_xy_prec,forc_xy_us ,forc_xy_vs       , &     
           idate,                                                   &
...
!f2py intent(in) forc_xy_psrf,forc_xy_solarin,forc_xy_frl,forc_xy_prec,forc_xy_us,forc_xy_vs 
...
!f2py depend(lon_points,lat_points) forc_xy_t,forc_xy_q,forc_xy_psrf,forc_xy_solarin,forc_xy_frl    
!f2py depend(lon_points,lat_points) forc_xy_prec,forc_xy_us,forc_xy_vs,oro
...
! ======================================================================
     ...
     CALL regular_forcing(idate,lon_points,lat_points, &
                           !INPUTS
                           forc_xy_t        , &
                           forc_xy_q        , &
                           forc_xy_psrf     , &
