...
!-----------------------------------------------------------------------
 ...
 subroutine socean (deltim,oro,hu,ht,hq,&
...
! specified (and invariant) thermal properties for surface types
   ...
   real(r8), parameter :: cmair  = 1.00e3 ! mass specific heat of air [J/kg/K]
   real(r8), parameter :: cmice  = 2.07e3 ! mass specific heat of ice [J/kg/K]
   real(r8), parameter :: frcair = 0.90   ! fraction of air assumed in mix of ice 
   real(r8), parameter :: rhair  = 1.25   ! mass density of surface air [kg/m3]
   real(r8), parameter :: rhice  = 9.20e2 ! mass density of ice [kg/m3]
   real(r8), parameter :: snwedp = 10.0   ! snow:water equivalent depth factor [-]
