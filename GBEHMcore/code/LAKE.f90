...
!-----------------------------------------------------------------------
  ...
  subroutine newsnow_lake ( &
            maxsnl    , nl_lake   , deltim      , dz_lake ,&! "in" arguments
            pg_rain   , pg_snow   , t_precip    , bifall  ,&
            t_lake    , zi_soisno , z_soisno ,&! "inout" arguments
...
!-----------------------------------------------------------------------
  ...
  subroutine laketem (&
           itypwat      , maxsnl      , nl_soil      , nl_lake   ,&! "in" arguments
           ...
           dkdry        , dksatu      , &
           t_grnd       , scv         , snowdp       , t_soisno  ,&! "inout" arguments
           wliq_soisno  , wice_soisno , imelt_soisno , t_lake    ,&
           lake_icefrac , &
           taux         , tauy        , fsena                    ,&! "out" arguments
...
!========================================================================================
!f2py intent(in) itypwat      , maxsnl      , nl_soil      , nl_lake   
!f2py intent(in) dlat         , deltim      , forc_hgt_u   , forc_hgt_t
!f2py intent(in) forc_hgt_q   , forc_us     , forc_vs      , forc_t    
!f2py intent(in) forc_q       , forc_rhoair , forc_psrf    , forc_sols 
!f2py intent(in) forc_soll    , forc_solsd  , forc_solld   , sabg      
!f2py intent(in) forc_frl     , dz_soisno   , z_soisno     , zi_soisno 
!f2py intent(in) dz_lake      , lakedepth   , csol         , porsl     
!f2py intent(in) dkdry        , dksatu 
!f2py intent(in,out) t_grnd       , scv         , snowdp       , t_soisno 
!f2py intent(in,out) wliq_soisno  , wice_soisno , imelt_soisno , t_lake 
!f2py intent(in,out) lake_icefrac 
!f2py intent(out) taux , tauy  , fsena       
!f2py intent(out) fevpa, lfevpa, fseng, fevpg
!f2py intent(out) qseva, qsubl , qsdew, qfros
!f2py intent(out) olrg , fgrnd , tref , qref 
!f2py intent(out) trad , emis  , z0ma , zol  
!f2py intent(out) rib  , ustar , qstar, tstar
!f2py intent(out) fm   , fh    , fq   , sm
!========================================================================================== 
...
!------------------------------------------------------------
      ...
      lb = snl+1
      call hCapacity (itypwat,lb,nl_soil,csol,porsl,&
...
!------------------------------------------------------------
  ...
  subroutine snowwater_lake ( &
             maxsnl      , nl_soil     , nl_lake   , deltim ,&! "in" arguments
             ssi         , wimp        , porsl     , pg_rain ,&
             pg_snow     , dz_lake     , imelt     , fiold ,&
             qseva       , qsubl       , qsdew     , qfros ,&
             z_soisno    , dz_soisno   , zi_soisno , t_soisno ,&! "inout" arguments
...
!==============================================================================
!f2py intent(in) maxsnl      , nl_soil     , nl_lake   , deltim 
!f2py intent(in) ssi         , wimp        , porsl     , pg_rain 
!f2py intent(in) pg_snow     , dz_lake     , imelt     , fiold 
!f2py intent(in) qseva       , qsubl       , qsdew     , qfros 
!f2py intent(in,out) z_soisno    , dz_soisno   , zi_soisno , t_soisno 
!f2py intent(in,out) wice_soisno , wliq_soisno , t_lake    , lake_icefrac 
!f2py intent(in,out) fseng       , fgrnd       , snl       , scv 
!f2py intent(in,out) snowdp      , sm 
!==============================================================================
