 ...
 subroutine orb_coszen_func(calday,dlon,dlat,orb_coszen)
...
!-------------------------------------------------------------------------------
   ...
   orb_coszen = sin(dlat)*sin(declin) &
              ...
              ! corrected by HY, 2016-11-18. from WIKIPEDIA
              - cos(dlat)*cos(declin)*cos(calday*2.0*pi+dlon)

 end subroutine orb_coszen_func
